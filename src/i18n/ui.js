...
const STRINGS = {
  cs: {
    ...
    'article.visualisation': 'Vizualizace',
    'article.diagram': 'Schéma',
    'article.notAPhoto': 'Vizualizace projektu, ne fotografie místa.',
  ...
  en: {
    ...
    'article.visualisation': 'Visualisation',
    'article.diagram': 'Diagram',
    'article.notAPhoto': 'A visualisation of the project, not a photograph of the place.',
    'article.share': 'Share',
