...
const ArticleCard = ({ post, locale, variant = 'default' }) => {
  ...
  if (variant === 'lead') {
    return (
      <Link to={to} className="group block">
        <Cover post={post} locale={locale} label={label} aspect="aspect-[21/9]" className="mb-stack-md" />
  ...
  if (variant === 'compact') {
    return (
      <Link to={to} className="group block">
        <Cover post={post} locale={locale} label={label} aspect="aspect-[16/9]" className="mb-3" />
  ...
  return (
    <Link to={to} className="group block">
      <Cover post={post} locale={locale} label={label} className="mb-stack-sm" />
